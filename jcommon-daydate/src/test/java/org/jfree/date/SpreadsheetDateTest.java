...
public class SpreadsheetDateTest extends TestCase {
    ...
    protected void setUp() {
        this.jan1Y1900 = new SpreadsheetDate(1, Month.fromInt(MonthConstants.JANUARY), 1900);
    ...
    public void test1Jan1900GetDayOfWeek() {
        ...
        assertEquals(Weekday.MONDAY.getIndex(), dayOfWeek);
    }
    ...
    public void test12Nov2001GetDayOfWeek() {
        SerialDate nov12Y2001 = new SpreadsheetDate(12,
        		Month.fromInt(MonthConstants.NOVEMBER), 2001);
    ...
    public void test28Feb1900ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(28, Month.fromInt(MonthConstants.FEBRUARY),
                1900);
    ...
    public void test01Mar1900ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(1, Month.fromInt(MonthConstants.MARCH), 1900);
    ...
    public void test31Dec1999ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(31, Month.fromInt(MonthConstants.DECEMBER), 
                1999);
    ...
    public void test01Jan2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(1, Month.fromInt(MonthConstants.JANUARY), 
                2000);
    ...
    public void test31Jan2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(31, Month.fromInt(MonthConstants.JANUARY), 
                2000);
    ...
    public void test01Feb2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(1, Month.fromInt(MonthConstants.FEBRUARY), 
                2000);
    ...
    public void test29feb2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(29, Month.fromInt(MonthConstants.FEBRUARY), 
                2000);
    ...
    public void test1mar2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(1, Month.fromInt(MonthConstants.MARCH), 2000);
